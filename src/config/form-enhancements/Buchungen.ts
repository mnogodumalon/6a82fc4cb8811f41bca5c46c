...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["hund", "besitzer", {"row": ["anreise", "abreise"]}, "platz", "status", "preis_gesamt", "zahlungsstatus", "interne_notizen"],
  defaults: {
    'anreise': { kind: 'today' },
  ...
  computed: {
    '_buchung_aufenthalt_dauer_nächte': { kind: 'dateDiff', from: 'anreise', to: 'abreise', unit: 'days' },
  },
};
