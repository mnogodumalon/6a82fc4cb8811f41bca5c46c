...
export const formEnhancements: FormEnhancements = {
  ...
  computed: {
    '_buchung_aufenthalts_nächte': { kind: 'dateDiff', from: 'anreise', to: 'abreise', unit: 'days' },
    'preis_gesamt': { op: 'mul', left: { kind: 'dateDiff', from: 'anreise', to: 'abreise', unit: 'days' }, right: { kind: 'literal', value: 50 } },
  },
};
