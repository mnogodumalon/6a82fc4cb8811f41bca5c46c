...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-buchung', label: { de: 'Neue Buchung', en: 'New booking' }, icon: IconCalendarPlus, description: 'Neue Hundepension-Buchung in 3 Schritten anlegen' },
  { path: '/intents/anfrage-bestaetigen', label: { de: 'Anfrage bearbeiten', en: 'Handle request' }, icon: IconClipboardCheck, description: 'Buchungsanfrage bestätigen oder ablehnen und direkt in eine Buchung umwandeln' },
