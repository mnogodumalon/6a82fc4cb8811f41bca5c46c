...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/anfrage-bestaetigen', label: { de: 'Anfrage bearbeiten', en: 'Process request' }, icon: IconClipboardCheck, description: 'Offene Buchungsanfrage prüfen und als Buchung bestätigen oder ablehnen' },
