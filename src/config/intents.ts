...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/anfrage-bestaetigen', label: { de: 'Anfrage bearbeiten', en: 'Process request' }, icon: IconClipboardCheck, description: 'Offene Buchungsanfrage bestätigen oder ablehnen und in Aufenthalt umwandeln' },
  { path: '/intents/pfoten-portraet', label: { de: 'Pfoten-Porträt', en: 'Paw portrait' }, icon: IconPaw, description: 'Individuelles Pfoten-Porträt für einen Hund und Besitzer erstellen' },
  // </custom:intents>
];
