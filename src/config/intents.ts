...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-buchung', label: { de: 'Neue Buchung', en: 'New booking' }, icon: IconCalendarPlus, description: 'Buchung schnell in 3 Schritten anlegen: Besitzer, Hund, Zeitraum & Platz' },
  { path: '/intents/anfrage-bestaetigen', label: { de: 'Anfrage bearbeiten', en: 'Handle request' }, icon: IconClipboardCheck, description: 'Offene Buchungsanfrage pruefen, bestaetigen und direkt als Buchung anlegen' },
  { path: '/intents/pfoten-portraet', label: { de: 'Pfoten-Porträt', en: 'Paw portrait' }, icon: IconPaw, description: 'Individuelles Pfoten-Portraet fuer einen Hund nach dem Aufenthalt erstellen' },
  // </custom:intents>
];
