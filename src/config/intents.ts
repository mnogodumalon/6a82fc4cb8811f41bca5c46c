...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/anfrage-bestaetigen', label: { de: 'Anfrage bearbeiten', en: 'Process request' }, icon: IconClipboardCheck, description: 'Offene Buchungsanfrage bestaetigen und direkt in eine Buchung umwandeln' },
  { path: '/intents/pfoten-portraet', label: { de: 'Pfoten-Portraet', en: 'Paw portrait' }, icon: IconPaw, description: 'Individuelles Pfoten-Portraet fuer einen Hund nach dem Aufenthalt erstellen' },
  // </custom:intents>
];
