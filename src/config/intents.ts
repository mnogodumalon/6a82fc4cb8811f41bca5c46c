...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/anfrage-bestaetigen', label: { de: 'Anfrage bestätigen', en: 'Confirm request' }, icon: IconClipboardCheck, description: 'Buchungsanfrage prüfen und direkt als Buchung bestätigen' },
  { path: '/intents/pfoten-portraet', label: { de: 'Pfoten-Porträt', en: 'Paw portrait' }, icon: IconPaw, description: 'Individuelles Pfoten-Porträt für einen Kunden erstellen' },
  // </custom:intents>
];
