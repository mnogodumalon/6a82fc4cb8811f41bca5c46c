...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-buchung', label: { de: 'Neue Buchung', en: 'New booking' }, icon: IconCalendarPlus, description: 'Buchung in 3 Schritten anlegen — Besitzer, Hund, Zeitraum & Platz' },
  { path: '/intents/anfrage-bearbeiten', label: { de: 'Anfrage bearbeiten', en: 'Process request' }, icon: IconClipboardCheck, description: 'Buchungsanfragen bestätigen oder ablehnen — bestätigte Anfragen werden direkt zu Buchungen' },
  { path: '/intents/pfoten-portraet', label: { de: 'Pfoten-Porträt', en: 'Paw portrait' }, icon: IconPaw, description: 'Individuelles Pfoten-Porträt für einen abgereisten Hund erstellen' },
  // </custom:intents>
];
