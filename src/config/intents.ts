...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-buchung', label: { de: 'Neue Buchung', en: 'New booking' }, icon: IconCalendarPlus, description: 'Buchung in 3 Schritten anlegen: Besitzer, Hund, Zeitraum' },
  { path: '/intents/anfrage-bestaetigen', label: { de: 'Anfrage bestaetigen', en: 'Confirm request' }, icon: IconClipboardCheck, description: 'Offene Buchungsanfrage pruefen und direkt als Buchung anlegen' },
  { path: '/intents/pfoten-portraet', label: { de: 'Pfoten-Portraet', en: 'Paw portrait' }, icon: IconPaw, description: 'Individuelles Pfoten-Portraet fuer einen Gast erstellen' },
  // </custom:intents>
];
