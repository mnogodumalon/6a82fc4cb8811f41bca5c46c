...
export default function BuchungenDetailPage() {
  ...
  return (
    ...
    >
      <RecordHeader title={appLabel('buchungen')} />
      ...
      <RecordSection title={t('details')} cols={2}>
        <RecordField label={fieldLabel('buchungen', 'hund')} value={getHundeDisplayName(record.fields.hund)} format="text" />
        <RecordField label={fieldLabel('buchungen', 'besitzer')} value={getBesitzerDisplayName(record.fields.besitzer)} format="text" />
