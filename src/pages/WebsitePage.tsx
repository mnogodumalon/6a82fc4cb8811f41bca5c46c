...
export default function WebsitePage() {
  ...
  async function loadData() {
    setLoading(true);
    try {
      setRecords(await LivingAppsService.getWebsite());
    } finally {
      setLoading(false);
    }
  }

  async function handleCreate(fields: Website['fields']) {
  ...
  async function handleUpdate(fields: Website['fields']) {
    ...
    await LivingAppsService.updateWebsiteEntry(editingRecord.record_id, fields);
    await loadData();
  ...
  async function handleDelete() {
    ...
    await LivingAppsService.deleteWebsiteEntry(deleteTarget.record_id);
  ...
  return (
    <PageShell
      title={appLabel('website')}
      subtitle={`${records.length} ${t('in_system', { entity: appLabel('website') })}`}
      action={
    ...
    >
      <div className="relative w-full max-w-sm">
        ...
        <Input
          placeholder={t('search_entity', { entity: appLabel('website') })}
          value={search}
        ...
        <Table className="[&_tbody_td]:px-6 [&_tbody_td]:py-2 [&_tbody_td]:text-base [&_tbody_td]:font-medium [&_tbody_tr:first-child_td]:pt-6 [&_tbody_tr:last-child_td]:pb-10">
            ...
            <TableRow className="border-b border-input">
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('unternehmensname')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'unternehmensname')}
              ...
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('beschreibung')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'beschreibung')}
              ...
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('anzahl_plaetze')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'anzahl_plaetze')}
              ...
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('oeffnungszeiten')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'oeffnungszeiten')}
              ...
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('website_telefon')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'website_telefon')}
                  {sortKey === 'website_telefon' ? (sortDir === 'asc' ? <IconArrowUp size={14} /> : <IconArrowDown size={14} />) : <IconArrowsUpDown size={14} className="opacity-30" />}
                </span>
              </TableHead>
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('website_email')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'website_email')}
                  {sortKey === 'website_email' ? (sortDir === 'asc' ? <IconArrowUp size={14} /> : <IconArrowDown size={14} />) : <IconArrowsUpDown size={14} className="opacity-30" />}
                </span>
              </TableHead>
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('website_url')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'website_url')}
                  {sortKey === 'website_url' ? (sortDir === 'asc' ? <IconArrowUp size={14} /> : <IconArrowDown size={14} />) : <IconArrowsUpDown size={14} className="opacity-30" />}
                </span>
              </TableHead>
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('website_strasse')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'website_strasse')}
                  {sortKey === 'website_strasse' ? (sortDir === 'asc' ? <IconArrowUp size={14} /> : <IconArrowDown size={14} />) : <IconArrowsUpDown size={14} className="opacity-30" />}
                </span>
              </TableHead>
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('website_hausnummer')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'website_hausnummer')}
                  {sortKey === 'website_hausnummer' ? (sortDir === 'asc' ? <IconArrowUp size={14} /> : <IconArrowDown size={14} />) : <IconArrowsUpDown size={14} className="opacity-30" />}
                </span>
              </TableHead>
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('website_plz')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'website_plz')}
                  {sortKey === 'website_plz' ? (sortDir === 'asc' ? <IconArrowUp size={14} /> : <IconArrowDown size={14} />) : <IconArrowsUpDown size={14} className="opacity-30" />}
                </span>
              </TableHead>
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('website_ort')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'website_ort')}
                  {sortKey === 'website_ort' ? (sortDir === 'asc' ? <IconArrowUp size={14} /> : <IconArrowDown size={14} />) : <IconArrowsUpDown size={14} className="opacity-30" />}
                </span>
              </TableHead>
              ...
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('titelbild')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'titelbild')}
                  {sortKey === 'titelbild' ? (sortDir === 'asc' ? <IconArrowUp size={14} /> : <IconArrowDown size={14} />) : <IconArrowsUpDown size={14} className="opacity-30" />}
                </span>
              </TableHead>
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('galerie_bilder')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'galerie_bilder')}
                  {sortKey === 'galerie_bilder' ? (sortDir === 'asc' ? <IconArrowUp size={14} /> : <IconArrowDown size={14} />) : <IconArrowsUpDown size={14} className="opacity-30" />}
                </span>
              </TableHead>
          ...
          <TableBody>
            {sortRecords(filtered).map(record => (
              <TableRow key={record.record_id} className="hover:bg-muted/50 transition-colors cursor-pointer" onClick={(e) => { if ((e.target as HTMLElement).closest('button, [role="checkbox"]')) return; navigate(`/website/${record.record_id}`); }}>
                ...
                <TableCell>{record.fields.website_telefon ?? '—'}</TableCell>
                <TableCell>{record.fields.website_email ?? '—'}</TableCell>
                <TableCell>{record.fields.website_url ?? '—'}</TableCell>
                <TableCell>{record.fields.website_strasse ?? '—'}</TableCell>
                <TableCell>{record.fields.website_hausnummer ?? '—'}</TableCell>
                <TableCell>{record.fields.website_plz ?? '—'}</TableCell>
                <TableCell>{record.fields.website_ort ?? '—'}</TableCell>
                ...
                <TableCell>{record.fields.titelbild ? <div className="relative h-8 w-8 rounded bg-muted overflow-hidden"><div className="absolute inset-0 flex items-center justify-center"><IconFileText size={14} className="text-muted-foreground" /></div><img src={record.fields.titelbild} alt="" className="relative h-full w-full object-cover" onError={e => { (e.target as HTMLImageElement).style.display = "none"; }} /></div> : '—'}</TableCell>
                <TableCell>{record.fields.galerie_bilder ? <div className="relative h-8 w-8 rounded bg-muted overflow-hidden"><div className="absolute inset-0 flex items-center justify-center"><IconFileText size={14} className="text-muted-foreground" /></div><img src={record.fields.galerie_bilder} alt="" className="relative h-full w-full object-cover" onError={e => { (e.target as HTMLImageElement).style.display = "none"; }} /></div> : '—'}</TableCell>
            ...
            {filtered.length === 0 && (
              <TableRow>
                <TableCell colSpan={20} className="text-center py-16 text-muted-foreground">
                  {search ? t('no_results') : t('no_data_yet', { entity: appLabel('website') })}
                </TableCell>
              </TableRow>
            )}
          </TableBody>
