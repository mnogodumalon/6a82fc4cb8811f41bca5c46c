...
export class LivingAppsService {
  ...
  static async getWebsite(): Promise<Website[]> {
    ...
    return enrichLookupFields(records, 'website');
  }
  static async getWebsiteEntry(id: string): Promise<Website | undefined> {
    ...
    return enrichLookupFields([record], 'website')[0];
  }
  ...
  static async getPfotenPortraets(): Promise<PfotenPortraets[]> {
    ...
    return enrichLookupFields(records, 'pfoten_portraets');
  }
  static async getPfotenPortraet(id: string): Promise<PfotenPortraets | undefined> {
    ...
    return enrichLookupFields([record], 'pfoten_portraets')[0];
  }
