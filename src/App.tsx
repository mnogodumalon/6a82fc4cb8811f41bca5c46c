...
import PfotenPortraetsPage from '@/pages/PfotenPortraetsPage';
import PfotenPortraetsDetailPage from '@/pages/PfotenPortraetsDetailPage';
// <custom:imports>
...
const IntentPfotenPortraetErstellenPage = lazy(() => import('@/pages/intents/PfotenPortraetErstellenPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="pfoten-portraets" element={<PfotenPortraetsPage />} />
                <Route path="pfoten-portraets/:id" element={<PfotenPortraetsDetailPage />} />
                ...
                <Route path="intents/pfoten-portraet" element={<Suspense fallback={null}><IntentPfotenPortraetErstellenPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
            </LocaleGate>
