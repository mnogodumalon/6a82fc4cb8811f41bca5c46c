  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'platz': (
      <div key="platz" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="platz" className="max-sm:h-11"><SelectValue placeholder="Welcher Platz (1–8)?" /></SelectTrigger>
          <SelectContent>
    ...
    'interne_notizen': (
      <div key="interne_notizen" className="space-y-1.5">
        ...
        <Textarea
          id="interne_notizen"
          placeholder="Spezielle Anforderungen, Zusatzleistungen, Allergien, Fütterungsplan..."
