  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'anreise': (
      <div key="anreise" className="space-y-1.5">
        ...
        <DatePicker
          id="anreise"
          placeholder="Anreisedatum wählen"
          mode="date"
    ...
    'abreise': (
      <div key="abreise" className="space-y-1.5">
        ...
        <DatePicker
          id="abreise"
          placeholder="Abreisedatum wählen"
          mode="date"
    ...
    'platz': (
      <div key="platz" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="platz" className="max-sm:h-11"><SelectValue placeholder="Welcher Platz?" /></SelectTrigger>
          <SelectContent>
    ...
    'interne_notizen': (
      <div key="interne_notizen" className="space-y-1.5">
        ...
        <Textarea
          id="interne_notizen"
          placeholder="Spezielle Wünsche, Hinweise für die Betreuung..."
