  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'platz': (
      <div key="platz" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="platz" className="max-sm:h-11"><SelectValue placeholder="Platznummer wählen" /></SelectTrigger>
          <SelectContent>
    ...
    'interne_notizen': (
      <div key="interne_notizen" className="space-y-1.5">
        ...
        <Textarea
          id="interne_notizen"
          placeholder="Notizen zum Aufenthalt, Besonderheiten..."
