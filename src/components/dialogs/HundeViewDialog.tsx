    ...
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">{fieldLabel('hunde', 'impfausweis_foto')}</Label>
            {record.fields.impfausweis_foto ? (
              <MediaThumbnail src={record.fields.impfausweis_foto} fit="contain" className="w-full rounded-lg border" />
          ...
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">{fieldLabel('hunde', 'medikamente')}</Label>
            <p className="text-sm whitespace-pre-wrap">{record.fields.medikamente ?? '—'}</p>
          </div>
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">{fieldLabel('hunde', 'tierarzt_name')}</Label>
            <p className="text-sm">{record.fields.tierarzt_name ?? '—'}</p>
          </div>
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">{fieldLabel('hunde', 'tierarzt_telefon')}</Label>
