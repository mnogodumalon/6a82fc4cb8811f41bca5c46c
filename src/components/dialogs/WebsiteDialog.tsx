  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'unternehmensname': (
      <div key="unternehmensname" className="space-y-1.5">
        ...
        <Input
          id="unternehmensname"
          placeholder="z. B. Pfotenpension Schmidt"
    ...
    'slogan': (
      <div key="slogan" className="space-y-1.5">
        ...
        <Input
          id="slogan"
          placeholder="z. B. Wo sich Hunde wohlfühlen"
          value={fields.slogan ?? ''}
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Über die Pension, Geschichte, Besonderheiten..."
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <Textarea
          id="leistungen"
          placeholder="Eine Leistung pro Zeile (z. B. Tagesbetreuung, Spielgruppen...)"
    ...
    'oeffnungszeiten': (
      <div key="oeffnungszeiten" className="space-y-1.5">
        ...
        <Textarea
          id="oeffnungszeiten"
          placeholder="Eine Zeile pro Öffnungszeit (Mo–Fr: 8–17 Uhr...)"
    ...
    'website_email': (
      <div key="website_email" className="space-y-1.5">
        ...
        <Input
          id="website_email"
          type="email"
          placeholder="z. B. kontakt@pension.de"
