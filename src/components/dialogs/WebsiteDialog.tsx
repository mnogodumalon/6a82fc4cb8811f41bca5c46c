  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'unternehmensname': (
      <div key="unternehmensname" className="space-y-1.5">
        ...
        <Input
          id="unternehmensname"
          placeholder="z. B. Pfotenpension Müller"
    ...
    'slogan': (
      <div key="slogan" className="space-y-1.5">
        ...
        <Input
          id="slogan"
          placeholder="z. B. Sicher und glücklich betreut"
          value={fields.slogan ?? ''}
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Willkommenstext, Geschichte, Besonderheiten..."
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <Textarea
          id="leistungen"
          placeholder="Übernachtung, Spielstunden, Training, Pflege..."
    ...
    'oeffnungszeiten': (
      <div key="oeffnungszeiten" className="space-y-1.5">
        ...
        <Textarea
          id="oeffnungszeiten"
          placeholder="Mo–Fr 8:00–18:00, Sa/So auf Anfrage..."
    ...
    'website_email': (
      <div key="website_email" className="space-y-1.5">
        ...
        <Input
          id="website_email"
          type="email"
          placeholder="kontakt@pfotenpension.de"
    ...
    'website_strasse': (
      <div key="website_strasse" className="space-y-1.5">
        ...
        <Input
          id="website_strasse"
          placeholder="z. B. Hundepark-Allee"
