  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'slogan': (
      <div key="slogan" className="space-y-1.5">
        ...
        <Input
          id="slogan"
          placeholder="z. B. Dein Hund ist bei uns in besten Pfoten"
          value={fields.slogan ?? ''}
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Wer sind wir? Wie lange betreiben wir die Pension? Was ist unsere Philosophie?"
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <Textarea
          id="leistungen"
          placeholder="Betreuung, Gassi, Training, spezielle Pflege, Besonderheiten..."
    ...
    'oeffnungszeiten': (
      <div key="oeffnungszeiten" className="space-y-1.5">
        ...
        <Textarea
          id="oeffnungszeiten"
          placeholder="Öffnungszeiten für Abholungen, Telefon-Hotline, Feiertags-Regelungen..."
