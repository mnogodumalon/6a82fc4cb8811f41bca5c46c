  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'slogan': (
      <div key="slogan" className="space-y-1.5">
        ...
        <Input
          id="slogan"
          placeholder="z. B. Dein Hund in besten Pfoten"
          value={fields.slogan ?? ''}
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Geschichte der Pension, Leidenschaft für Hunde, Erfahrung, Mission..."
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <Textarea
          id="leistungen"
          placeholder="Eine Leistung pro Zeile (z. B. Tagesbetreuung, Gassi, Fütterung...)"
    ...
    'oeffnungszeiten': (
      <div key="oeffnungszeiten" className="space-y-1.5">
        ...
        <Textarea
          id="oeffnungszeiten"
          placeholder="Eine Zeitspanne pro Zeile (z. B. Mo–Fr 08:00–18:00, Sa 10:00–14:00...)"
