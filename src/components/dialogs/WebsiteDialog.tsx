  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'slogan': (
      <div key="slogan" className="space-y-1.5">
        ...
        <Input
          id="slogan"
          placeholder="z. B. Der beste Platz für Dein Tier"
          value={fields.slogan ?? ''}
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Wer sind wir? Was ist unsere Geschichte? Was ist uns wichtig?"
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <Textarea
          id="leistungen"
          placeholder="Eine Leistung pro Zeile — Betreuung, Fütterung, Spiele, etc."
    ...
    'oeffnungszeiten': (
      <div key="oeffnungszeiten" className="space-y-1.5">
        ...
        <Textarea
          id="oeffnungszeiten"
          placeholder="Mo–Fr 08:00–18:00, Sa/So nach Absprache etc. — eine pro Zeile"
    ...
    'website_email': (
      <div key="website_email" className="space-y-1.5">
        ...
        <Input
          id="website_email"
          type="email"
          placeholder="z. B. kontakt@pfotenpension.de"
