  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'unternehmensname': (
      <div key="unternehmensname" className="space-y-1.5">
        ...
        <Input
          id="unternehmensname"
          placeholder="z. B. Pfotenpension Am Wald"
    ...
    'slogan': (
      <div key="slogan" className="space-y-1.5">
        ...
        <Input
          id="slogan"
          placeholder="z. B. Urlaubsparadies für Hunde"
          value={fields.slogan ?? ''}
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Wer seid ihr? Was zeichnet euch aus? Wie lange am Markt? Besonderheiten..."
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <Textarea
          id="leistungen"
          placeholder="Eine Leistung pro Zeile. z. B. Tagesvollbetreuung, Trainingseinheiten, Katzensit"
    ...
    'oeffnungszeiten': (
      <div key="oeffnungszeiten" className="space-y-1.5">
        ...
        <Textarea
          id="oeffnungszeiten"
          placeholder="Zeitfenster pro Zeile. z. B. Montag–Freitag 08:00–18:00, Samstag 09:00–14:00..."
    ...
    'website_email': (
      <div key="website_email" className="space-y-1.5">
        ...
        <Input
          id="website_email"
          type="email"
          placeholder="z. B. info@pfotenpension-wald.de"
