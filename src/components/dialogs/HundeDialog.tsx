  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'geburtsdatum': (
      <div key="geburtsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="geburtsdatum"
          placeholder="Wann wurde er geboren?"
          mode="date"
    ...
    'fuetterungshinweise': (
      <div key="fuetterungshinweise" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Fütterungszeiten, Futtersorte, Allergien, Portionen..."
    ...
    'medikamente': (
      <div key="medikamente" className="space-y-1.5">
        ...
        <Textarea
          id="medikamente"
          placeholder="Medikamente, Verhalten, Besonderheiten..."
    ...
    'tierarzt_name': (
      <div key="tierarzt_name" className="space-y-1.5">
        ...
        <Input
          id="tierarzt_name"
          placeholder="z. B. Dr. Müller, Praxis am Markt"
