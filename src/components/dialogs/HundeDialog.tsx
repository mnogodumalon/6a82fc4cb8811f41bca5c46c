  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'rasse': (
      <div key="rasse" className="space-y-1.5">
        ...
        <Input
          id="rasse"
          placeholder="z. B. Deutscher Schäferhund"
          value={fields.rasse ?? ''}
    ...
    'fuetterungshinweise': (
      <div key="fuetterungshinweise" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Futterart, Menge, Zeiten, Allergien..."
    ...
    'medikamente': (
      <div key="medikamente" className="space-y-1.5">
        ...
        <Textarea
          id="medikamente"
          placeholder="Medikamente, Dosierung, Verabreichungszeiten..."
    ...
    'tierarzt_name': (
      <div key="tierarzt_name" className="space-y-1.5">
        ...
        <Input
          id="tierarzt_name"
          placeholder="z. B. Dr. Schmidt, Praxis Berlin"
