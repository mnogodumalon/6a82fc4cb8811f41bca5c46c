  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'fuetterungshinweise': (
      <div key="fuetterungshinweise" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Futtersorte, Menge, Allergien, Fütterungszeiten..."
    ...
    'medikamente': (
      <div key="medikamente" className="space-y-1.5">
        ...
        <Textarea
          id="medikamente"
          placeholder="Regelmäßige Medikamente, Besonderheiten, Verhaltensweisen..."
    ...
    'tierarzt_name': (
      <div key="tierarzt_name" className="space-y-1.5">
        ...
        <Input
          id="tierarzt_name"
          placeholder="z. B. Dr. Müller, Tierarztpraxis Am Park"
