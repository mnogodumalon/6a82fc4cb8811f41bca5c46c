  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'fuetterungshinweise': (
      <div key="fuetterungshinweise" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Fütterungszeiten, Futtersorten, Portionsgröße..."
    ...
    'medikamente': (
      <div key="medikamente" className="space-y-1.5">
        ...
        <Textarea
          id="medikamente"
          placeholder="Medikamente, Unverträglichkeiten, Verhaltenspapiere..."
    ...
    'tierarzt_name': (
      <div key="tierarzt_name" className="space-y-1.5">
        ...
        <Input
          id="tierarzt_name"
          placeholder="z. B. Dr. Müller, Tierarzt Friedrichshain"
