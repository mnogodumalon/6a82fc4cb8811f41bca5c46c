    ...
    try {
      ...
      if (file && (file.type.startsWith('image/') || file.type === 'application/pdf')) {
        try {
          ...
          setFields(prev => ({ ...prev, impfausweis_foto: fileUrl }));
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'geburtsdatum': (
      <div key="geburtsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="geburtsdatum"
          placeholder="Wann ist der Hund geboren?"
          mode="date"
    ...
    'geschlecht': (
      <div key="geschlecht" className="space-y-1.5">
        ...
        <div role="radiogroup" className="flex flex-wrap gap-1.5">
          ...
          >
            {lookupLabel('hunde', 'geschlecht', 'unbekannt') ?? 'Unbekannt'}
          </button>
        </div>
      </div>
    ),
    ...
    'kastriert': (
      <div key="kastriert" className="space-y-1.5">
        <Label htmlFor="kastriert">{fieldLabel('hunde', 'kastriert')}</Label>
        <div className="flex items-center gap-2 pt-1">
          ...
          />
          <Label htmlFor="kastriert" className="font-normal">{fieldLabel('hunde', 'kastriert')}</Label>
        </div>
      </div>
    ),
    'impfstatus': (
    ...
    'impfausweis_foto': (
      <div key="impfausweis_foto" className="space-y-1.5">
        <Label htmlFor="impfausweis_foto">{fieldLabel('hunde', 'impfausweis_foto')}</Label>
        {fields.impfausweis_foto ? (
          <div className="flex items-center gap-3 rounded-lg border p-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm truncate text-foreground">{fields.impfausweis_foto.split("/").pop()}</p>
              <div className="flex gap-2 mt-1">
                  ...
                  <input
                    ...
                    onChange={async (e) => {
                      ...
                      try {
                        ...
                        setFields(f => ({ ...f, impfausweis_foto: fileUrl }));
                ...
                <button
                  ...
                  onClick={() => setFields(f => ({ ...f, impfausweis_foto: undefined }))}
                >
                  {t('fr_remove')}
                </button>
              </div>
    ...
    'fuetterungshinweise': (
      <div key="fuetterungshinweise" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Fütterungszeiten, Menge, Unverträglichkeiten, Allergien..."
    ...
    'medikamente': (
      <div key="medikamente" className="space-y-1.5">
        <Label htmlFor="medikamente">{fieldLabel('hunde', 'medikamente')}</Label>
        <Textarea
          id="medikamente"
          placeholder="Medikamente, Dosierung, Besonderheiten beim Umgang..."
    ...
    'tierarzt_name': (
      <div key="tierarzt_name" className="space-y-1.5">
        <Label htmlFor="tierarzt_name">{fieldLabel('hunde', 'tierarzt_name')}</Label>
        <Input
          id="tierarzt_name"
          placeholder="z. B. Dr. Schmidt, Tierarztpraxis Mitte"
    ...
    'tierarzt_telefon': (
      <div key="tierarzt_telefon" className="space-y-1.5">
        <Label htmlFor="tierarzt_telefon">{fieldLabel('hunde', 'tierarzt_telefon')}</Label>
        <Input
          id="tierarzt_telefon"
    ...
    'besitzer': (
      <div key="besitzer" className="space-y-1.5">
        ...
        <Combobox
          id="besitzer"
          placeholder="Wähle den Hundebesitzer"
