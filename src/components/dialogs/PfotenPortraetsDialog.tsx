  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'widmung': (
      <div key="widmung" className="space-y-1.5">
        ...
        <Textarea
          id="widmung"
          placeholder="Persönliche Widmung, liebevolle Grußworte, Charakterbeschreibung..."
    ...
    'besondere_erlebnisse': (
      <div key="besondere_erlebnisse" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Highlights des Aufenthalts, Abenteuer, lustige Momente..."
    ...
    'zusatztext': (
      <div key="zusatztext" className="space-y-1.5">
        ...
        <Textarea
          id="zusatztext"
          placeholder="Zusätzliche Anmerkungen, Danksagung, persönliche Botschaft..."
