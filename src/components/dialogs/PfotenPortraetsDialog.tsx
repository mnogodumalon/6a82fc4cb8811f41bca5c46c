  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'widmung': (
      <div key="widmung" className="space-y-1.5">
        ...
        <Textarea
          id="widmung"
          placeholder="Persönliche Grußbotschaft, Name des Besitzers..."
    ...
    'besondere_erlebnisse': (
      <div key="besondere_erlebnisse" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Highlights, Abenteuer, lustige Momente während des Aufenthalts..."
    ...
    'erstellungsdatum': (
      <div key="erstellungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="erstellungsdatum"
          placeholder="Heute oder Datum wählen?"
          mode="date"
    ...
    'zusatztext': (
      <div key="zusatztext" className="space-y-1.5">
        ...
        <Textarea
          id="zusatztext"
          placeholder="Sonstiges über den Hund, Meta-Anmerkungen..."
