  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'buchung': (
      <div key="buchung" className="space-y-1.5">
        ...
        <Combobox
          id="buchung"
          placeholder="Zugehörige Buchung auswählen"
    ...
    'widmung': (
      <div key="widmung" className="space-y-1.5">
        ...
        <Textarea
          id="widmung"
          placeholder="Persönlicher Gruß, Geschichte, Erinnerung..."
    ...
    'besondere_erlebnisse': (
      <div key="besondere_erlebnisse" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Ereignisse, Abenteuer, Highlights während des Aufenthalts..."
    ...
    'erstellungsdatum': (
      <div key="erstellungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="erstellungsdatum"
          placeholder="Datum des Porträts?"
          mode="date"
    ...
    'zusatztext': (
      <div key="zusatztext" className="space-y-1.5">
        ...
        <Textarea
          id="zusatztext"
          placeholder="Zusätzliche Anmerkungen, Danksagungen..."
