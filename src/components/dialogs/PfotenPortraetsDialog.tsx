  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'buchung': (
      <div key="buchung" className="space-y-1.5">
        ...
        <Combobox
          id="buchung"
          placeholder="Zu welcher Buchung?"
    ...
    'widmung': (
      <div key="widmung" className="space-y-1.5">
        ...
        <Textarea
          id="widmung"
          placeholder="Persönliche Worte, Dankeschön, Grüße..."
    ...
    'besondere_erlebnisse': (
      <div key="besondere_erlebnisse" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Besondere Momente während des Aufenthalts..."
    ...
    'zusatztext': (
      <div key="zusatztext" className="space-y-1.5">
        ...
        <Textarea
          id="zusatztext"
          placeholder="Weitere Anmerkungen, Grussbotschaften..."
