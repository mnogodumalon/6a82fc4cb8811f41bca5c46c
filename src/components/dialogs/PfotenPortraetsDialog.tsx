  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'hund': (
      <div key="hund" className="space-y-1.5">
        ...
        <Combobox
          id="hund"
          placeholder="Welcher Hund wird porträtiert?"
    ...
    'buchung': (
      <div key="buchung" className="space-y-1.5">
        ...
        <Combobox
          id="buchung"
          placeholder="Welche Buchung, falls vorhanden?"
    ...
    'widmung': (
      <div key="widmung" className="space-y-1.5">
        ...
        <Textarea
          id="widmung"
          placeholder="Persönliche Widmung für die Familie, Erinnerungen, Dankesworte..."
    ...
    'besondere_erlebnisse': (
      <div key="besondere_erlebnisse" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Besondere Momente, lustige Abenteuer, Erfolge..."
    ...
    'zusatztext': (
      <div key="zusatztext" className="space-y-1.5">
        ...
        <Textarea
          id="zusatztext"
          placeholder="Weitere Anmerkungen, Fotokredits, Anekdoten..."
