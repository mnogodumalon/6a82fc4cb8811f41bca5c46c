  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'hund': (
      <div key="hund" className="space-y-1.5">
        ...
        <Combobox
          id="hund"
          placeholder="Welcher Hund ist das?"
    ...
    'buchung': (
      <div key="buchung" className="space-y-1.5">
        ...
        <Combobox
          id="buchung"
          placeholder="Welche Buchung gehört dazu?"
    ...
    'widmung': (
      <div key="widmung" className="space-y-1.5">
        ...
        <Textarea
          id="widmung"
          placeholder="Persönliche Nachricht, Geschichte über den Hund..."
    ...
    'besondere_erlebnisse': (
      <div key="besondere_erlebnisse" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was hat der Hund Schönes erlebt? Spiele, Freundschaften..."
    ...
    'zusatztext': (
      <div key="zusatztext" className="space-y-1.5">
        ...
        <Textarea
          id="zusatztext"
          placeholder="Weitere Infos oder Anmerkungen..."
