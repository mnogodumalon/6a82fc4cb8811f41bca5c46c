  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'widmung': (
      <div key="widmung" className="space-y-1.5">
        ...
        <Textarea
          id="widmung"
          placeholder="Persönliche Botschaft, Grüße, Zitate über den Hund..."
    ...
    'besondere_erlebnisse': (
      <div key="besondere_erlebnisse" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Highlights aus dem Aufenthalt, lustige Momente, besondere Aktivitäten..."
    ...
    'zusatztext': (
      <div key="zusatztext" className="space-y-1.5">
        ...
        <Textarea
          id="zusatztext"
          placeholder="Weitere Informationen, Tipps, Empfehlungen..."
