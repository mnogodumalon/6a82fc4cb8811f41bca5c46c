  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'buchung': (
      <div key="buchung" className="space-y-1.5">
        ...
        <Combobox
          id="buchung"
          placeholder="Welche Buchung zugehörig? (optional)"
    ...
    'widmung': (
      <div key="widmung" className="space-y-1.5">
        ...
        <Textarea
          id="widmung"
          placeholder="Persönliche Worte für Hund/Besitzer. z. B. Lieber Max, ein Wochenende voller Spa"
    ...
    'besondere_erlebnisse': (
      <div key="besondere_erlebnisse" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Lustige, rührende oder bemerkenswerte Momente. z. B. Mit den anderen Hunden im G"
    ...
    'erstellungsdatum': (
      <div key="erstellungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="erstellungsdatum"
          placeholder="Wann wurde das Porträt erstellt?"
          mode="date"
    ...
    'zusatztext': (
      <div key="zusatztext" className="space-y-1.5">
        ...
        <Textarea
          id="zusatztext"
          placeholder="Weitere Notizen, Credits, spezielle Effekte, Editor-Hinweise..."
