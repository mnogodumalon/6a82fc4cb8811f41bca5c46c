  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'widmung': (
      <div key="widmung" className="space-y-1.5">
        ...
        <Textarea
          id="widmung"
          placeholder="Persönliche Grußbotschaft für den Hund und Besitzer..."
    ...
    'besondere_erlebnisse': (
      <div key="besondere_erlebnisse" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Schöne oder lustige Momente während des Aufenthalts..."
    ...
    'zusatztext': (
      <div key="zusatztext" className="space-y-1.5">
        ...
        <Textarea
          id="zusatztext"
          placeholder="Weitere Anmerkungen, kleine Geschichte..."
